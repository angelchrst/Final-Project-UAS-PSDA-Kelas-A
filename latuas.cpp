...
int main()
{
    ...
    while (1)
    {
        ...
        cout<<" 3. Cari elemen dan cetak jalur tempuh"<<endl;
        cout<<" 4. Hapus elemen "<<endl;
        cout<<" 5. Tampilkan nilai terbesar dan terkecil"<<endl;
        cout<<" 6. Reset BST"<<endl;
...
void BST::insert(node *tree, node *newnode)
{
    if (root == NULL)
    {
        ...
        root->kiri = NULL;
        root->kanan = NULL;
        cout<<" Root node telah ditambahkan"<<endl;
        return;
    }
    if (tree->info == newnode->info)
    {
        cout<<" Elemen sudah ada dalam Tree"<<endl;
        return;
    }
    if (tree->info > newnode->info)
    {
	...
	else
	{
            ...
            cout<<" Node kiri ditambahkan"<<endl;
            return;
        }
    }
    else
    {
        ...
        else
        {
            ...
            cout<<" Node kanan ditambahkan"<<endl;
            return;
        }	
    }
}
...
void BST::del(int elemen)
{
    ...
    if (lokasi == NULL)
    {
        cout<<" Elemen tidak tersedia dalam Tree"<<endl;
        return;
    }
